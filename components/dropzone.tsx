  ...
  return (
    <DropzoneContext.Provider value={{ ...restProps }}>
      <div
        {...getRootProps({
          className: cn(
            "border-2 border-gray-300 rounded-lg text-center bg-card transition-colors duration-300 text-foreground",
            className,
...
const DropzoneEmptyState = ({ className }: { className?: string }) => {
  ...
  return (
    <a
      ...
      className="underline cursor-pointer transition hover:text-foreground p-6"
    >
      <div className={cn("flex flex-col items-center gap-y-2", className)}>
        ...
        <div className="flex flex-col items-center gap-y-1">
          <p className="text-xs text-muted-foreground">
            Drag and drop or select {maxFiles === 1 ? `file` : "files"} to
            upload
          </p>
